...
`,T=S.b`
  ...
  ${L}
`;var _=function(e,t,r,n){return new(r||(r=Promise))(function(i,o){function a(e){try{c(n.next(e))}catch(t){o(t)}}function s(e){try{c(n.throw(e))}catch(t){o(t)}}function c(e){e.done?i(e.value):new r(function(t){t(e.value)}).then(a,s)}c((n=n.apply(e,t||[])).next())})};const w=A.named("Business").props({code:d.i.maybeNull(d.i.string),banners:d.i.map(P)}).volatile(()=>({isBrand:!1,isMobileApp:!1,branch:null,country:null,orderOrigin:C.c.WEB,routerBasePath:""})).views(e=>({get branchId(){return e.branch&&e.branch.id},get companyId(){return e.branch&&e.branch.company.id},get brandId(){return e.branch&&e.branch.brand.id},get isValid(){return null!==e.branch},get requestedCode(){let t=Object({NODE_ENV:"production",PUBLIC_URL:"",REACT_APP_LOCAL_ENDPOINT:"https://be.dev.admin.c2e.deep-vision.cloud",REACT_APP_STAGE:"prod"}).REACT_APP_BUSINESS_CODE||null;if(!t){t=new window.URL(window.location.href).searchParams.get(G)||null||e.code}return t}})).actions(e=>({updateFromLookup(t){const{isBrand:r,isMobileApp:n,knownBasePath:i,orderOrigin:o,branch:a}=t;a&&(e.isBrand=r,e.isMobileApp=n,e.branch=a,e.country=a.address.country||null,e.routerBasePath=i,e.orderOrigin=o,a.id!==e.root.order.branchId&&e.root.order.orderCancel(),e.code=null)},mockBranchData(t){e.branch=t}})).actions(e=>({afterAttach(){return _(this,void 0,void 0,function*(){Object(v.D)(()=>e.root.initialized,()=>_(this,void 0,void 0,function*(){const{data:t}=yield e.client.query({query:T,variables:{code:e.requestedCode}});if(!(t&&t.lookup&&t.lookup.branch))return Object(p.e)("no business found, used code %s",e.requestedCode),void window.location.replace(m.a.redirectOnFail);e.updateFromLookup(t.lookup),Object(h.f)({requestedCode:e.requestedCode,branchId:e.branchId,brandId:e.brandId,companyId:e.companyId,isBrand:e.isBrand}),Object(p.e)("identified branch %s, brand %s; company %s, isBrand: %s",e.branchId,e.brandId,e.companyId,e.isBrand)}))})},ensureBannerForCurrentBranch(){const t=e.branchId;return e.banners.has(t)||e.banners.set(t,{branchId:t}),e.banners.get(t)}})),G="wac";const M=A.named("Config").props({orderItemsMax:50});var $=r(15),F=r(57),j=r(12);const U=S.b`
...
//# sourceMappingURL=main.43d92758.chunk.js.map